(function() {
  ...
  describe('NxRedirect2url.methods', function() {
    ...
    test('encode default with redirect: redirect_url', function () {
      ...
      expect(str).toBe('http://192.168.50.181/login?redirect_url=https%3A%2F%2Fwww.mipengine.org%3Fq1%3D1%26q2%3D2');
    });

    test('decode deafult', ()=>{
      var res = NxRedirect2url.decode({
        url: 'http://192.168.50.181/login?redirect_url=https%3A%2F%2Fwww.mipengine.org%3Fq1%3D1%26q2%3D2',
        query:'redirect_url'
      });
